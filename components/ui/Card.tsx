...
export function Card({ children, className = "", hover = false, glow = false }: CardProps) {
  return (
    <motion.div
      ...
      className={[
        "relative bg-bg-card border border-white/[0.06] rounded-2xl p-6",
        "transition-all duration-300",
        hover && "cursor-pointer hover:border-violet-500/40 hover:bg-bg-card-hover hover:shadow-[0_8px_40px_rgba(124,58,237,0.15)]",
